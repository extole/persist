...
public @interface Column {
    ...
    /**
     * If the field is read-only (e.g., database computed columns, views).
     * This will hint the engine to avoid using the field in insert/update automatic operations,
     * but still include it in select operations. Unlike autoGenerated, readOnly fields are
     * never updated back to the object, even if updateAutoGeneratedKeys is set to true.
     */
